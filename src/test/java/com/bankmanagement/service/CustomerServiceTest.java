...
public class CustomerServiceTest {
   ...
   // Customer customer = CustomerDto.builder().customerId(4L).bankId(1L).firstName("Sanjay").lastName("Datta").age(32).email("sanjay@gmail.com").aadhaarNumber("272235944450").contactNumber(8876643234L).address("Mumbai").panCardNumber("AANS234KKL").dateOfBirth("1983-09-20").build();
    @InjectMocks
...
//        Customer customer = Customer.builder().customerId(1L).bankId(1L).firstName("Sanjay").lastName("Datta").age(32).email("sanjay@gmail.com").aadhaarNumber("222233944450").contactNumber(8876643234L).address("Mumbai").panCardNumber("AANS234KKL").dateOfBirth("1983-09-20").build();
//        Mockito.when(customerRepository.findById(customer.getCustomerId())).thenReturn(Optional.of(customer1));
